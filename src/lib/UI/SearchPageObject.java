...
public class SearchPageObject extends MainPageObject {
    private static final String
            ...
            SEARCH_ELEMENT_TEXT_ATTRIBUTE = "org.wikipedia:id/search_src_text",
            SEARCH_EMPTY_MESSAGE = "org.wikipedia:id/search_empty_message",
            SEARCH_TITLE_TEXT = "org.wikipedia:id/view_page_title_text";
    ...
    public String defineElementText() {
        WebElement title_element = this.waitForElementPresent(
                By.id(SEARCH_ELEMENT_TEXT_ATTRIBUTE),
    ...
    public void assertThereIsNoResultOfSearch() {
        this.assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT),"Cannot find empty result element");
