...
public class FirstTest {
    ...
    public void testCancelSearchHomeWork() {
        ...
        waitForElementPresent(
                ...
                "Cannot find any articles topic searching by 'Apple'",
                5
        );
        ...
        Assert.assertEquals(
                "We see unexpected number of articles searching by 'Apple', presented number is 5",
                5,
                count
        );
...
//        );
    ...
    public void saveTwoArticlesToMyList() {
        ...
        //вот здесь должна начинаться часть с поиском другой статьи
        waitForElementAndClick(
                By.xpath("//*[contains(@text,'Search Wikipedia')]"),
                "Cannot find 'Search Wikipedia' input",
                5
        ...
        waitForElementAndClick(
                ...
                "Cannot find javascript search result",
                5
        );
        ...
        String name_of_article_in_list = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/page_list_item_title"),
                "text",
        ...
        String name_of_article_on_page = waitForElementAndGetAttribute(
                By.id("org.wikipedia:id/view_page_title_text"),
                "text",
    ...
    private void getWordInSearchResult(By by, String value) {
        List<WebElement> articles = driver.findElements(by);
    ...
    private void assertElementPresent(By by, String error_message) {
        int title_of_article = getAmountOfElements(by);
